...
conversation_history = [
    {
        ...
        Answer in teaching manner. DO NOT EXCEED 300 WORDS PER ANSWER. Answer in JSON format like {"resp_user": "HERE YOU SHOULD PUT THE ANSWER TO USER", "context": "HERE YOU SHOULD PUT THE SUMMARY OF THE TEXTS AND SUMMARY OF CONVERSATION, SO YOU WON'T FORGET"}. 
